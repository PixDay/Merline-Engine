...
class GameObject
{
    public:
        GameObject();
        GameObject(std::function<void(GameObject const &)>);
       ~GameObject() = default;

        void update();
        void onCollide(GameObject const &object);
        ...
        void setFunction(std::function<void(GameObject const &)> function);
        void setOnCollide(std::function<void(GameObject const &, GameObject const &)> onCollide);
     ...
     private:
        ...
        float                                                               _speed;
        bool                                                                _active;
        std::function<void(GameObject const &)>                             _function;
        std::function<void(GameObject const &, GameObject const &)>         _onCollide;
};
