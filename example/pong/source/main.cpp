...
{
    App app = App();
    TextObject playerScore = TextObject("0");
    TextObject botScore = TextObject("-1");
    DisplayableObject player1 = DisplayableObject("../../img/player.png", &player);
    DisplayableObject player2 = DisplayableObject("../../img/player.png", &secondPlayer);
    DisplayableObject line1 = DisplayableObject("../../img/line.png");
    DisplayableObject line2 = DisplayableObject("../../img/line.png");
    DisplayableObject ball = DisplayableObject("../../img/ball.png", &ballMovement);
    ...
    app.addObject(DisplayableObject("../../img/background.png"));
    app.addObject(ball);
    app.addObject(line1);
    app.addObject(line2);
